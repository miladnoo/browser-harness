...
Available interaction skills (all registered — use when you need help with a specific mechanic):
- `interaction-skills/connection.md` — startup sequence, tab visibility, omnibox popup fix
- `interaction-skills/cookies.md` — read and set cookies
- `interaction-skills/cross-origin-iframes.md` — iframe handling across origins
- `interaction-skills/dialogs.md` — alert/confirm/prompt/beforeunload dialogs
- `interaction-skills/downloads.md` — track and access downloaded files
- `interaction-skills/drag-and-drop.md` — drag and drop interactions
- `interaction-skills/dropdowns.md` — native and custom dropdowns
- `interaction-skills/iframes.md` — general iframe handling
- `interaction-skills/input-focus.md` — click-to-focus before type_text on React/Vue/SPAs
- `interaction-skills/loading-spinners.md` — wait for client-side spinners that wait_for_load misses
- `interaction-skills/network-requests.md` — intercept/see network traffic
- `interaction-skills/print-as-pdf.md` — print to PDF
- `interaction-skills/profile-sync.md` — sync local Chrome profile to cloud
- `interaction-skills/screenshots.md` — screenshot utilities
- `interaction-skills/scrolling.md` — scrollIntoView, smooth scroll
- `interaction-skills/shadow-dom.md` — shadow DOM traversal
- `interaction-skills/tabs.md` — tab creation, switching, closing
- `interaction-skills/uploads.md` — file upload via DOM
- `interaction-skills/viewport.md` — viewport sizing

Available domain skills:
- `tiktok/upload.md`
- `domain-skills/x/post.md` — post text + image or video to X.com (auto-converts non-H.264 video)
...
- **Screenshots first**: use `screenshot()` to understand the current page quickly, find visible targets, and decide whether you need a click, a selector, or more navigation. **Always use `mcp__MiniMax__understand_image` to analyze screenshots** — don't try to read the raw image file yourself.
